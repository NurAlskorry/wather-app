...
void BuildingURL()
{
  ...
  println(i++ + ". URL for Current Calgary Call:", URLCurrentCalgary);
  println(i++ + ". URL for Forecast Calgary Call:", URLForecastCalgary);
  println(i++ + ". URL for Current RedDeer Call:", URLCurrentRedDeer);
  println(i++ + ". URL for Forecast RedDeer Call:", URLForecastRedDeer);
